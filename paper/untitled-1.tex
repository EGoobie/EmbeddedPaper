...
\section{Isolation Circuit Structure}
\subsection{180\degree\space Circular Hybrid Structure for Full Duplex Applications}
...
\subsection{180\degree\space Phase Inverter Structures}
The parallel stripline phase inverter functions by swapping the signals on the top and bottom striplines. Since in a parallel stripline structure, a signal propagates along the top and bottom lines with the same magnitude but opposite phase, swapping the signals on the top and bottom effectively inverts the phase of the signal. As seen in  Fig.\ref{fig_structure1}, the phase inverter structure proposed in \cite{chiu_compact_2013} consists of a straightened Z-shaped cut through the line. This poses two problems for the circuit. First, the line is suddenly cut in half without a taper causing reflections off of the cut section, and second, the optimal cut width and via hole diameter push the the limits of the smallest possible cut and hole for fabrication. Therefore, it was desired to improve upon this inverter and enhance the ease of fabrication while keeping the parallel stripline structure of the circuit. 

\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{structure1.jpg}
\DeclareGraphicsExtensions.
\caption{Original proposed structure with phase inverter.}
\label{fig_structure1}
\end{figure} 
