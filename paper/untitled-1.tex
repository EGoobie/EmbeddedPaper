...
The audio effects processing unit was required to have four functions: Left-right balance, 3-band equalization, echo, and master volume. 
...
The next step in the signal path was the 3-band equalizer, which can be seen in Figure Y. 
